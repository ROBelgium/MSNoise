"""
This function gives the relative travel time variations (dt/t) between cross-correlations
along with the associated error in the measurement. you can set the frequency range in which 
you want to determine dt/t, i.e. you can measure dt/t in a narrow frequency band even for a broadband signal. 
